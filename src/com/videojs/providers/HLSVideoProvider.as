package com.videojs.providers{
    ...
    public class HLSVideoProvider implements IProvider {
        ...
        public function appendBuffer(bytes:ByteArray):void {
          throw "HLSVideoProvider does not support appendBuffer";
        }
        ...
        public function endOfStream():void{
            throw "HLSVideoProvider does not support endOfStream";
        }

        public function abort():void{
            throw "HLSVideoProvider does not support abort";
        }

        public function discontinuity():void{
            throw "HLSVideoProvider does not support discontinuities";
        }
